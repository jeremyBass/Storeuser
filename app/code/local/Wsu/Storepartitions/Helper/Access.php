<?php
class Wsu_Storepartitions_Helper_Access extends Mage_Core_Helper_Abstract {
    ...
    public function setCmsObjectStores($object) {
        ...
        $allowedStoreviewIds = Mage::getSingleton('storepartitions/role')->getAllowedStoreviewIds();
    ...
    public function setProductWebsites($product) {
        ...
        $allowedWebsites    = Mage::getSingleton('storepartitions/role')->getAllowedWebsiteIds();
    ...
    public function getFilteredStoreIds($storeIds) {
        $allowedStoreIds = Mage::getSingleton('storepartitions/role')->getAllowedStoreviewIds();
