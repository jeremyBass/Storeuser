<?php
class Wsu_Storeuser_Block_Rewrite_AdminhtmlCatalogFormRendererFieldsetElement extends Mage_Adminhtml_Block_Catalog_Form_Renderer_Fieldset_Element {
                ...
                $html .= '
                    ...
                    if (Prototype.Browser.IE){
                        if (window.addEventListener){
                            window.addEventListener("load", storeuser_disable_msrp, false);
                        }else{
                            window.attachEvent("onload", storeuser_disable_msrp);
                        }
                    }else{
                        document.observe("dom:loaded", storeuser_disable_msrp);
                    }

                    function storeuser_disable_msrp(){
