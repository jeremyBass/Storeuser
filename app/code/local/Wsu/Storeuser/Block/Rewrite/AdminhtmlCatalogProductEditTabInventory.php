<?php
class Wsu_Storeuser_Block_Rewrite_AdminhtmlCatalogProductEditTabInventory extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Inventory {
    protected function _toHtml() {
        ...
        return parent::_toHtml() . '
            <input id="storeuser_inventory_manage_stock_default" name="product[stock_data][use_config_manage_stock]" type="hidden" value="1" />
            ...
            function disableInventoryInputs(){
                ...
                if(typeof($("inventory_use_config_manage_stock")) != "undefined");{
                    if($("inventory_use_config_manage_stock").checked){
                        $("storeuser_inventory_manage_stock_default").value = 1;
                    }else{
                        $("storeuser_inventory_manage_stock_default").value = 0;
                    }
                }
            }
            //]]>
