<?php
class Wsu_Storeuser_Block_Rewrite_AdminNewsletterSubscriberGrid extends Mage_Adminhtml_Block_Newsletter_Subscriber_Grid {
    protected function _prepareCollection() {
        ...
        if (!Mage::helper('storeuser')->isShowingAllCustomers()) {
