<?php
class Wsu_Storeuser_Block_Rewrite_AdminhtmlCatalogProductEditActionAttributeTabInventory extends Mage_Adminhtml_Block_Catalog_Product_Edit_Action_Attribute_Tab_Inventory {
