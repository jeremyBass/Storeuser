<?php
class Wsu_Storeuser_Model_Observer {
    private $_role = null;
    protected $_helper;
    protected $_helperAccess;
    public function __construct() {
        $this->_helper       = Mage::helper('storeuser');
        $this->_helperAccess = Mage::helper('storeuser/access');
    }
    private function _getCurrentRole() {
        if (null == $this->_role) {
            $this->_role = Mage::getSingleton('storeuser/role');
        }
        return $this->_role;
    }
    ...
    private function _saveRoleStoreRestriction($roleId) {
        ...
        foreach ($selectedStoreIds as $storeId => $storeviewIds) {
            ...
            $advancedrole = Mage::getModel('storeuser/advancedrole');
    ...
    public function deleteAdvancedRole($roleId) {
        Mage::getModel('storeuser/advancedrole')->deleteRole($roleId);
    }
